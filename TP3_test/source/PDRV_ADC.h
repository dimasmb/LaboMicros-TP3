...
#ifndef PDRV_ADC_H_
#define PDRV_ADC_H_
//Parametro pa inicializarlo
/*ADC_n adc1=1;
	ADC_adiclock clk=bus_clock;
	ADCClock_Divide clkd=input_clock;
	ADCCycles_t cycles=0;
	ADCBits_t resol=ADC_b12;
	ADC_Init(adc1,resol,cycles,clkd,0,0b10010);*/
